package com.nice.libnavcomplier;
...
@SupportedAnnotationTypes({"com.nice.libnavannotation.FragmentDestination", "com.nice.libnavannotation.ActivityDestination"})
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        if (!fragmentElements.isEmpty() || !activityElements.isEmpty()) {
            ...
            try {
                ...
                //利用fast接送把收集到的所有页面信息转换JSON格式。并输出到文件中
